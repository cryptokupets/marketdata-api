...
class Backtest {
    constructor({ _id, assetKey, currencyKey, exchangeKey, timeframe, start, end, strategyCode, initialBalance, finalBalance, profit, result, indicatorInputs, stoplossEnabled, stopLossLevel, fee }) {
        Object.assign(this, {
            _id,
            assetKey,
            currencyKey,
