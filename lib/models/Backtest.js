...
class Backtest {
    constructor({ _id, assetKey, currencyKey, exchangeKey, timeframe, start, end, strategyCode, initialBalance, indicatorInputs, candles, indicators, advices, trades, rows }) {
        Object.assign(this, {
            _id,
            assetKey,
            currencyKey,
