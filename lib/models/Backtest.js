...
const BacktestRow_1 = require("./BacktestRow");
const BalanceItem_1 = require("./BalanceItem");
const Candle_1 = require("./Candle");
const Indicator_1 = require("./Indicator");
const Trade_1 = require("./Trade");
class Backtest {
    constructor({ _id, assetKey, currencyKey, exchangeKey, timeframe, start, end, strategyCode, initialBalance, indicatorInputs, candles, indicators, advices, trades, balance, rows }) {
        Object.assign(this, {
            _id,
            assetKey,
            currencyKey,
...
__decorate([
    odata_v4_server_1.Edm.Collection(odata_v4_server_1.Edm.EntityType(odata_v4_server_1.Edm.ForwardRef(() => BacktestRow_1.BacktestRow)))
], Backtest.prototype, "rows", void 0);
