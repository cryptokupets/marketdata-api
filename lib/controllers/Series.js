...
let SeriesController = class SeriesController extends odata_v4_server_1.ODataController {
    get(query) {
    ...
    getById(key, query) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const db = yield connect_1.default();
            return new Series_1.Series(yield db.collection(collectionName).findOne({ _id }, { projection }));
        });
    }
    patch(key, delta) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (delta.chartId) {
                delta.chartId = new mongodb_1.ObjectID(delta.chartId);
            }
            // tslint:disable-next-line: variable-name
            const _id = new mongodb_1.ObjectID(key);
