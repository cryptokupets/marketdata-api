...
let BacktestController = class BacktestController extends odata_v4_server_1.ODataController {
    ...
    getCurrency(result) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _id = new mongodb_1.ObjectID(key);
            const db = yield connect_1.default();
            const { exchangeKey, currencyKey } = new Backtest_2.Backtest(yield db.collection(collectionName).findOne({ _id }));
            return new Currency_1.Currency({ key: currencyKey, exchangeKey });
        });
    }
    getOutput(result) {
        return __awaiter(this, void 0, void 0, function* () {
...
__decorate([
    odata_v4_server_1.odata.GET("Currency"),
    __param(0, odata_v4_server_1.odata.result)
], BacktestController.prototype, "getCurrency", null);
__decorate([
