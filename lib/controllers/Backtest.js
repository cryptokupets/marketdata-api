...
let BacktestController = class BacktestController extends odata_v4_server_1.ODataController {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = typeof mongodbQuery.limit === "number" && mongodbQuery.limit === 0
                ...
                : yield db
                    ...
                    .map(e => new Backtest_1.Backtest(e))
                    .toArray();
    ...
    getById(key, query) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const db = yield connect_1.default();
            const backtest = new Backtest_1.Backtest(yield db.collection(collectionName).findOne({ _id }, { projection }));
            return backtest;
        });
    }
    post({ assetKey, currencyKey, exchangeKey, timeframe, start, end, strategyCode, initialBalance }) {
        return __awaiter(this, void 0, void 0, function* () {
            const backtest = new Backtest_1.Backtest({
                assetKey,
                currencyKey,
                exchangeKey,
                timeframe,
    ...
    patch(key, { assetKey, currencyKey, exchangeKey, timeframe, start, end, strategyCode, initialBalance }) {
        return __awaiter(this, void 0, void 0, function* () {
            const delta = new Backtest_1.Backtest({
                assetKey,
                currencyKey,
                exchangeKey,
                timeframe,
...
BacktestController = __decorate([
    odata_v4_server_1.odata.type(Backtest_1.Backtest),
