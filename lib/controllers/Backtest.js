...
let BacktestController = class BacktestController extends odata_v4_server_1.ODataController {
    ...
    post({ assetKey, currencyKey, exchangeKey, timeframe, start, end, strategyCode, initialBalance, indicatorInputs, stoplossEnabled, stopLossLevel, fee }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getExchange(result) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _id = new mongodb_1.ObjectID(key);
            const db = yield connect_1.default();
            const { exchangeKey } = new Backtest_2.Backtest(yield db.collection(collectionName).findOne({ _id }));
    ...
    getOutput(result) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _id = new mongodb_1.ObjectID(key);
            const db = yield connect_1.default();
            const { exchangeKey, currencyKey, assetKey, timeframe, start, end, indicatorInputs, strategyCode, initialBalance, stoplossEnabled, stopLossLevel, fee } = new Backtest_2.Backtest(yield db.collection(collectionName).findOne({ _id }));
            // добавить свечи
