...
let BacktestController = class BacktestController extends odata_v4_server_1.ODataController {
    ...
    getById(key, query) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const db = yield connect_1.default();
            return new Backtest_1.Backtest(yield db.collection(collectionName).findOne({ _id }, { projection }));
        });
    }
    post(body) {
        return __awaiter(this, void 0, void 0, function* () {
            const backtest = new Backtest_1.Backtest(body);
    ...
    getExchange(result) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _id = new mongodb_1.ObjectID(key);
            const db = yield connect_1.default();
            const { exchangeKey } = new Backtest_1.Backtest(yield db.collection(collectionName).findOne({ _id }));
            return new Exchange_1.Exchange(exchangeKey);
        });
    }
};
__decorate([
